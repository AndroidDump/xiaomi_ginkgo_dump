...
cat cust/app/customized/SuperWallpaperSnowmountain/SuperWallpaperSnowmountain.apk.* 2>/dev/null >> cust/app/customized/SuperWallpaperSnowmountain/SuperWallpaperSnowmountain.apk
rm -f cust/app/customized/SuperWallpaperSnowmountain/SuperWallpaperSnowmountain.apk.* 2>/dev/null
cat cust/app/customized/SuperWallpaperEarth/SuperWallpaperEarth.apk.* 2>/dev/null >> cust/app/customized/SuperWallpaperEarth/SuperWallpaperEarth.apk
rm -f cust/app/customized/SuperWallpaperEarth/SuperWallpaperEarth.apk.* 2>/dev/null
cat cust/app/customized/SuperWallpaperMars/SuperWallpaperMars.apk.* 2>/dev/null >> cust/app/customized/SuperWallpaperMars/SuperWallpaperMars.apk
rm -f cust/app/customized/SuperWallpaperMars/SuperWallpaperMars.apk.* 2>/dev/null
